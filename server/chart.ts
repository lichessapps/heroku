function autoGenerateData():number[]{
...
function createChart(blob:any=undefined,callback:any=undefined,errcallback:any=undefined){
...
function createChartInner(blob:any,callback:any,errcallback:any){
    ...
    if(data.length>1){        
        ...
        function y2c(y:number){return MARGIN_TOP+CHART_HEIGHT-(y-MIN_Y)*Y_SCALE}
        function x2c(x:number){return MARGIN_LEFT+x*X_SCALE}   
        ...
        function drawLine(cx0:number,cy0:number,cx1:number,cy1:number){            
        ...
        for(let i=1;i<data.length;i++){                
            ...
            function drawMovingAverage(){
                ...
                let sumPrev=data.slice(i-MOVING_AVERAGE,i).reduce((a:number,b:number)=>a+b)
                let sumCurr=data.slice(i+1-MOVING_AVERAGE,i+1).reduce((a:number,b:number)=>a+b)                      
